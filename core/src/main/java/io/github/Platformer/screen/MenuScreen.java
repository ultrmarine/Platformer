...
public class MenuScreen implements Screen {
    ...
    public MenuScreen(GdxGame game) {
        ...
        this.font = new BitmapFont(); // позволяет что либо писать букавками внутри игры (русский кста не поддерживает)
    }
    ...
    public void render(float delta) {
        ...
        batch.begin();
        font.draw(batch, "click",100,100);
        batch.end();

        if (Gdx.input.isTouched()) { //чекаем нажал ли что либо игрок
